...
BEGIN
  ...
  VALUES
    (p_user_id, 'Manifest parcels', '📦', 'Shipping', 15, 2, 1),
    (p_user_id, 'Post parcels', '📮', 'Shipping', 30, 2, 2),
    (p_user_id, 'Photography session', '📷', 'Listing', 120, 3, 3),
    (p_user_id, 'Returns processing', '🔄', 'Shipping', 30, 2, 4),
    (p_user_id, 'Returns inspection', '🔍', 'Shipping', 20, 3, 5),
    (p_user_id, 'Packing supplies run', '🛒', 'Admin', 45, 3, 6),
    (p_user_id, 'Storage organisation', '🗄️', 'Admin', 60, 4, 7),
    (p_user_id, 'Bank deposit', '🏦', 'Admin', 20, 3, 8),
    (p_user_id, 'Auction attendance', '🔨', 'Sourcing', 180, 3, 9),
    (p_user_id, 'Car boot sale', '🚗', 'Sourcing', 180, 3, 10);
