-- In-stock tracked ASINs move from DAILY to WEEKLY Keepa cadence (Chris 2026-07-20:
-- "daily feels completely unnecessary"). The SP-API overlay cron already refreshes
-- the same ~257 in-stock ASINs every morning with buy_box_price / buy_box_is_yours /
-- your_price / offer_count — seller-identity data Keepa cannot provide. Keepa's
-- unique fields (drops90, was-90d avg) move slowly; weekly loses nothing.
-- Frees ~220 scheduler slots/day for the stale/arb backfill arms.
