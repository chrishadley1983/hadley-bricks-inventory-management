...
describe('useInventorySummary', () => {
  ...
  it('fetches inventory summary', async () => {
    const mockSummary = {
      ...
      valueByStatus: {
        'IN STOCK': { cost: 2500, listingValue: 3500, count: 50 },
        LISTED: { cost: 1500, listingValue: 2500, count: 30 },
        SOLD: { cost: 1000, listingValue: 1500, count: 20 },
      },
    };
